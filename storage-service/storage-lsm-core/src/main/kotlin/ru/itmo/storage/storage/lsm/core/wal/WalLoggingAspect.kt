...
import ru.itmo.storage.storage.lsm.core.wal.entry.flush.SSTableFlushWalEntry
import ru.itmo.storage.storage.lsm.core.wal.entry.flush.SSTableFlushWalEntryData
import ru.itmo.storage.storage.lsm.core.wal.entry.upsert.UpsertWalEntry
...
class WalLoggingAspect {
    ...
    @Pointcut("within(ru.itmo.storage.storage.lsm.core.MemtableService+)")
